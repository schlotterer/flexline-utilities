...
class Admin {
	...
	public static function register_settings() {
		...
		// --- SEO SECTION (fields printed directly) ---
			...
			function () {
				...
				<p>
					...
					<span class="description">
						Outputs &lt;meta property="og:*"&gt; tags (title, description, URL, image, type) and a matching
						&lt;meta name="description"&gt; for better social sharing.
					</span>
				</p>
				<p>
					<label>
					...
					<span class="description">
						If enabled, the plugin won’t output OG tags when Yoast SEO is installed (Yoast will handle them).
					</span>
				</p>
				<?php
			},
		...
		// --- SECURITY SECTION (fields printed directly) ---
		add_settings_section(
			...
			function () {
				...
				<p>
					...
					<span class="description">
						Adds “Access-Control-Allow-Origin: *” to REST responses. Useful for public APIs—but avoid if you need to restrict origins.
					</span>
				</p>
				<?php
			},
	...
	public static function sanitize_options( $input ) {
		...
		// Ensure any missing keys fall back to defaults.
	...
	public static function render_page() {
		...
		<div class="wrap">
			...
			<form method="post" action="options.php" style="margin-bottom:2rem;">
				...
				do_settings_sections('flexline_utilities'); // Renders SEO and Security sections (no tables)
				submit_button();
				?>
			</form>
